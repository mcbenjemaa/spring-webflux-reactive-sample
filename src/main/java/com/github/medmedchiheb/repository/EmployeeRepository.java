...
public class EmployeeRepository {
    ...
    static
    {
        ...
        employeeData.put("1",new Employee("1","Employee 1", "213", 450));
        employeeData.put("2",new Employee("2","Employee 2", "213", 450));
        employeeData.put("3",new Employee("3","Employee 3", "213", 450));
        employeeData.put("4",new Employee("4","Employee 4", "213", 450));
        employeeData.put("5",new Employee("5","Employee 5", "213", 450));
        employeeData.put("6",new Employee("6","Employee 6", "213", 450));
        employeeData.put("7",new Employee("7","Employee 7", "213", 450));
        employeeData.put("8",new Employee("8","Employee 8", "213", 450));
        employeeData.put("9",new Employee("9","Employee 9", "213", 450));
        employeeData.put("10",new Employee("10","Employee 10", "213", 450));
